# Milestone 1 history — archived detail (frozen 2026-09-05)

> Relocated verbatim from `PLAN/MILESTONES/M1-deepcdefocus-v1.md` to keep the live milestone
> file's read cost bounded. Three blocks: the done phases' full task briefs (original lines
> 304–1374, including a frozen snapshot of the still-open M1.P3.T5 brief), the dated
> `## Decisions` log through 2026-08-23 (original lines 1482–3233), and the board's
> "Where things stand" status narrative (original lines 3241–3513). Checkboxes and status
> statements in here are frozen snapshots — live task state lives in the milestone file.
> This file is an archive: never read it on the normal startup path (PLAN-FORMAT.md §7).
...
## Status log (relocated from the board, 2026-09-05)

> Moved verbatim from PLAN.md's `# Open questions` section by /cat-compact — the running
> "Where things stand" narrative, its carried obligations, and the standing lesson. Newest-first
> per-task entries; the rulings they summarize live in `## Decisions` above.
