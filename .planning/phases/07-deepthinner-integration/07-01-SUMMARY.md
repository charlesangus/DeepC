...
plan: 01
subsystem: plugin
tags: [cmake, nuke, deepfilterop, cpp, vendoring]
...
# Tech tracking
tech-stack:
  added: [DeepFilterOp (upstream DeepThinner uses this Nuke base class)]
  patterns: [Non-wrapped plugin vendoring — DeepThinner placed in PLUGINS list (not PLUGINS_WRAPPED or PLUGINS_MWRAPPED), FILTER_NODES menu category variable mirrors existing DRAW_NODES/CHANNEL_NODES/etc pattern]

key-files:
  created:
    - src/DeepThinner.cpp
    - icons/DeepThinner.png
  modified:
    - src/CMakeLists.txt
    - python/menu.py.in
    - CMakeLists.txt
...
requirements-completed: [THIN-01, THIN-02, THIN-03, THIN-04]
